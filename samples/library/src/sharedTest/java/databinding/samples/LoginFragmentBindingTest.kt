...
class LoginFragmentBindingTest {

    @Test
    @UiThreadTest
    fun bindLoginViewState() = inflate<LoginFragmentBinding>(R.layout.fragment_login) {
    ...
    fun clickOnLoginButton() = inflate<LoginFragmentBinding>(R.layout.fragment_login) {
        viewModel = mock()
